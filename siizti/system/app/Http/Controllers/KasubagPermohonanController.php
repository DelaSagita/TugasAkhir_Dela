...
class KasubagPermohonanController extends Controller
{
   function indexCuti(){
        ...
        return view('kasubag.permohonan.cuti.index',$data);
    }
    ...
    function createCuti(){
        ...
        ->where('status_plh', 1)
        ->get();
        return view('kasubag.permohonan.cuti.create',$data);
    }
    ...
    return redirect('k/permohonan/cuti')->with('success','Cuti Berhasil Diajukan');
}

function showCuti(Cuti $cuti){
    $data['cuti'] = $cuti;
    return view('kasubag.permohonan.cuti.show',$data);
}
...
function indexTidakmasuk(){
    ...
    ->where('flag_erase',1)
    ->count();
    return view('kasubag.permohonan.tidak-masuk.index',$data);
}
...
function storeTidakmasuk(){
    ...
    return redirect('k/permohonan/tidak-masuk')->with('success','Permohonan tidak masuk telah diajukan');
}

function cetakTidakmasuk(TidakMasuk $tidakmasuk){
    $data['detail'] = $tidakmasuk;
    $data['logo'] = '/../public/logo/logo-pn-ketapang.png';
    return view('kasubag.permohonan.tidak-masuk.cetak',$data);
...
function cetakTidakmasukPegawai(TidakMasuk $tidakmasuk){
    ...
    $data['logo'] = '/../public/logo/logo-pn-ketapang.png';
    return view('kasubag.permohonan.tidak-masuk.cetak-pegawai',$data);
...
function indexKeluarkantor(){
    ...
    return view('kasubag.permohonan.keluar-kantor.index',$data);
}
...
function createKeluarkantor(){
    ...
    return view('kasubag.permohonan.keluar-kantor.create',$data);
}

function storeKeluarkantor(){
    $pimpinan_bidang = Bidang::where('bidang_id',16)->first();
    ...
    $keluar->status = 0;
    $keluar->id_pimpinan_bidang = $pimpinan_bidang->bidang_pimpinan_id;
    ...
    return redirect('k/permohonan/keluar-kantor')->with('success','Izin keluar kantor sedang diproses, silahkan tunggu notifikasi selanjutnya.');
}
...
function cetakKeluarkantor(KeluarKantor $keluarkantor){
    ...
    return view('kasubag.permohonan.keluar-kantor.cetak',$data);
...
function showKeluarkantor(KeluarKantor $keluarkantor){
    ...
    $data['detail'] = $keluarkantor;
    return view('kasubag.permohonan.keluar-kantor.show',$data);
