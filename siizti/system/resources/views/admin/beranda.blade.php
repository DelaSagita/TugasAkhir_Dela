             ...
             <!--  <div class="col-lg-12 col-md-12 order-1">
                <div class="row">
                  <div class="col-lg-3 col-md-12 col-6 mb-4">
                    <div class="card">
                      ...
                      <h4 class="card-title mb-2">{{$jumlah_cuti_aktif}} Hari</h4>
                      <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> dari jumlah_cuti_aktif Hari</small>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-3 col-md-12 col-6 mb-4">
                  <div class="card">
                    ...
                    <h4 class="card-title text-nowrap mb-1">1O Hari</h4>
              ...
              <div class="col-lg-3 col-md-12 col-6 mb-4">
                  <div class="card">
                    ...
                    <h4 class="card-title text-nowrap mb-1">7 Hari</h4>
                    <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> Tahun Ini</small>
                  </div>
                </div>
              </div>
               ...
               <div class="col-lg-3 col-md-12 col-6 mb-4">
                  <div class="card">
                    ...
                    <h4 class="card-title text-nowrap mb-1">0 Hari</h4>
                    <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> Tahun Ini</small>
                  </div>
                </div>
              </div>
                  ...
                  <div class="card-body">
                    ...
                    <ul class="p-0 m-0">
                      ...
                      <li class="d-flex mb-4 pb-1">
                        ...
                        <a href="{{url('p/permohonan/keluar-kantor',$s->keluar_kantor_id)}}/detail">
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
