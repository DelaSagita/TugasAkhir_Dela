        ...
        <!-- Modal Backdrop -->
            ...
            <div class="modal fade" id="backDropModal" data-bs-backdrop="static" tabindex="-1">
              <div class="modal-dialog">
                <form class="modal-content" action="{{url('admin/pengaturan/pimpinan/update')}}" method="post">
                  @csrf
                  <div class="modal-header">
                    <h5 class="modal-title" id="backDropModalTitle">Ganti Pimpinan PN</h5>
                    <button
                    type="button"
                    class="btn-close"
                  ...
                  <div class="modal-body">
                    <div class="row">
                      <div class="col mb-3">
                        <select class="form-control" required name="pimpinan_baru" >
                        ...
                        <input type="hidden" name="pimpinan_lama" value="{{$detail->pegawai_id}}">
