...
<div class="container mt-3 mb-5">
	...
	<div class="col-lg-12 mb-4 order-0">
		<div class="card">
			<div class="d-flex align-items-end row">
				<div class="col-sm-7">
					<div class="card-body">
						<h5 class="card-title text-primary">Form Pengajuan Cuti Pegawai</h5>
						<p class="mb-4">
							Jumlah Pegawai Aktif Sekrang <span class="fw-bold">87 Orang</span> 
						</p>
					</div>
				</div>
	...
	<div class="card">
		<div class="card-body">
			<form action="{{url('kb/permohonan/cuti/create')}}" method="post" enctype="multipart/form-data">
				@csrf
				<div class="row">
