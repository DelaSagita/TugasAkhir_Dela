	...
	<div class="col-lg-12 mb-4 order-0">
		<div class="card">
			<div class="d-flex align-items-end row">
				<div class="col-sm-7">
					<div class="card-body">
						<h5 class="card-title text-primary"> DATA PERMOHONAN UNTUK KELUAR KANTOR</h5>
						<p class="mb-4">
							Jumlah Pegawai sedang keluar sekarang {{$hari_ini}} Org <span class="fw-bold">.</span> 
						</p>
						...
						<tr>
							...
							<td>
								<div class="btn-group">
									...
									@elseif($c->status == 1)
									<a href="{{url('kb/permohonan-masuk/keluar-kantor',$c->keluar_kantor_id)}}/detail" class="btn btn-warning"><i class="fa fa-eye"></i></a>
									<a href="{{url('kb/permohonan-masuk/keluar-kantor',$c->keluar_kantor_id)}}/cetak" target="_blank" class="btn btn-dark"><i class="fa fa-file"></i></a>
									@elseif($c->status == 2)
									<a href="{{url('kb/permohonan-masuk/keluar-kantor',$c->keluar_kantor_id)}}/detail" class="btn btn-warning"><i class="fa fa-eye"></i></a>
									@endif
