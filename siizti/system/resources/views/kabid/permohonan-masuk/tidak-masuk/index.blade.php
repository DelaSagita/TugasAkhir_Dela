						...
						<tr>
							...
							<td>
								<div class="btn-group">
									...
									<a href="{{url('kb/permohonan-masuk/tidak-masuk',$c->td_masuk_id)}}/detail" class="btn btn-secondary"><i class="fa fa-eye"></i></a>
									@if($c->status == 2)
									<a href="{{url('kb/permohonan-masuk/tidak-masuk',$c->td_masuk_id)}}/cetak" target="_blank" class="btn btn-dark btn-sm"><i class="fa fa-file"></i> Pimpinan</a>

									<a href="{{url('kb/permohonan-masuk/tidak-masuk',$c->td_masuk_id)}}/cetak-pegawai" target="_blank" class="btn btn-dark btn-sm"><i class="fa fa-file"></i> Pegawai</a>
									@endif
