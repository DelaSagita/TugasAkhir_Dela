          ...
          <table class="table table-borderless table-hover">
            ...
            <tr>
              ...
              <div class="modal fade" id="tolakKabid" data-bs-backdrop="static" tabindex="-1">
                <div class="modal-dialog">
                  <form class="modal-content" action="{{url('k/permohonan-masuk/cuti',$detail->cuti_id)}}/tolak-kasubag" method="post">
                    @csrf
                    @method("PUT")
                    <div class="modal-header">
                      <h5 class="modal-title" id="backDropModalTitle">Alasan Penolakan</h5>
              ...
              <a href="{{url('kb/permohonan-masuk/cuti',$detail->cuti_id)}}/terima-kabid" onclick="return confirm('Yakin Menerima Izin Ini?')" class="btn btn-success btn-block"><i class="fa fa-check"></i> Terima</a>
              ...
              <div class="modal fade" id="tangguhkanKabid" data-bs-backdrop="static" tabindex="-1">
                <div class="modal-dialog">
                  <form class="modal-content" action="{{url('kb/permohonan-masuk/cuti',$detail->cuti_id)}}/tangguhkan" method="post">
                    @csrf
                    @method("PUT")
                    <div class="modal-header">
              ...
              <div class="modal fade" id="perubahanKabid" data-bs-backdrop="static" tabindex="-1">
                <div class="modal-dialog">
                  <form class="modal-content" action="{{url('kb/permohonan-masuk/cuti',$detail->cuti_id)}}/perubahan" method="post">
                    @csrf
                    @method("PUT")
                    <div class="modal-header">
