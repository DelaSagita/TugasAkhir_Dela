...
<div class="col-lg-12 mb-4 order-0">
	...
	<div class="card mb-3">
		<div class="card-body">
			<a href="{{url('kb/permohonan-masuk/cuti')}}" class="btn btn-warning"><i class="fa fa-warning"></i> Permohonan Baru</a>
			<a href="{{url('kb/permohonan-masuk/cuti/validasi')}}" class="btn btn-success"><i class="fa fa-check"></i> Permohonan Tervalidasi</a>
			<a href="{{url('kb/permohonan-masuk/cuti/tolak')}}" class="btn btn-danger"><i class="fa fa-times"></i> Permohonan Ditolak</a>
		</div>
	</div>
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<div class="btn-group">
									<a href="{{url('/kb/permohonan-masuk/cuti',$c->cuti_id)}}/detail" class="btn btn-warning btn-sm"><i class="fa fa-eye"></i></a>
									@if($c->cuti_status == 6)
									<a href="{{url('/kb/permohonan/cuti',$c->cuti_id)}}/cetak" class="btn btn-dark btn-sm"><i class="fa fa-file"></i></a>
									@endif
								</div>
							</td>
						</tr>
