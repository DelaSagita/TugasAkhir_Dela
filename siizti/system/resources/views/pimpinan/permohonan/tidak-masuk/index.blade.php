			...
			<div class="d-flex align-items-end row">
				<div class="col-sm-7">
					<div class="card-body">
						...
						<a href="{{url('pimpinan/permohonan/tidak-masuk/create')}}" class="btn btn-sm btn-outline-primary"><i class="fa fa-plus"></i> Ajukan Izin Baru</a>
					</div>
				</div>
		...
		<div class="card-body">
			<div class="row">
				...
				<table class="table table-hover">
					...
					<tbody>
						@foreach($list_data->sortByDesc('td_masuk_id') as $c)
						<tr>
