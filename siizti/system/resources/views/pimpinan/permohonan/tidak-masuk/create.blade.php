...
<div class="container mt-3 mb-5">
	...
	<div class="card">
		<div class="card-body">
			<form action="{{url('pimpinan/permohonan/tidak-masuk/create')}}" method="post" enctype="multipart/form-data">
				@csrf
				<div class="row">

					<div class="col-md-6 mt-3">
						<span>Tanggal Mulai Tidak Masuk Kerja</span>
						<input type="date" class="form-control" name="tgl_mulai_izin">
					</div>

					<div class="col-md-6 mt-3">
						<span>Tanggal Selesai Tidak Masuk Kerja</span>
						<input type="date" class="form-control" name="tgl_selesai_izin">
					</div>

					<div class="col-md-6 mt-3">
						<span>Alasan Tidak Masuk Kerja</span>
						<textarea name="alasan_izin" id="" cols="30" rows="3" class="form-control"></textarea>
					</div>
