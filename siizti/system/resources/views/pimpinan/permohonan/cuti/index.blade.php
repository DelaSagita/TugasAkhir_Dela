			...
			<div class="d-flex align-items-end row">
				<div class="col-sm-7">
					<div class="card-body">
						...
						<a href="{{url('pimpinan/permohonan/cuti/create')}}" class="btn btn-sm btn-outline-primary"><i class="fa fa-plus"></i> AJUKAN CUTI BARU</a>
					</div>
				</div>
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<div class="btn-group">
									<a href="{{url('/p/permohonan/cuti',$c->cuti_id)}}/show" class="btn btn-warning btn-sm"><i class="fa fa-eye"></i> Lihat</a>
									<a href="{{url('/pimpinan/permohonan/cuti',$c->cuti_id)}}/cetak" target="_blank" class="btn btn-dark btn-sm"><i class="fa fa-file"></i> Cetak</a>
									@if($c->cuti_status == 0)
									<a href="{{url('/p/permohonan/cuti',$c->cuti_id)}}/hapus" class="btn btn-danger btn-sm">Hapus</a>
									@endif
								</div>
							</td>
						</tr>
