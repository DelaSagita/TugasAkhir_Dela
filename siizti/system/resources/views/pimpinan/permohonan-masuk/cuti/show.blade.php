          ...
          <table class="table table-borderless table-hover">
            ...
            <tr>
              ...
              <td>
                ...
                @if($detail->cuti_status == 0 && Auth::user()->pegawai_pimpinan == 1)
                <div class="mt-3 row">
                  ...
                  <div class="modal fade" id="backDropModalTerima" data-bs-backdrop="static" tabindex="-1">
                    <div class="modal-dialog">
                      <form class="modal-content" action="{{url('kb/permohonan-masuk/cuti',$detail->cuti_id)}}/terima-kasubag" method="post">
                        @csrf
                        @method("PUT")
                ...
                <div class="modal fade" id="backDropModal" data-bs-backdrop="static" tabindex="-1">
                  <div class="modal-dialog">
                    <form class="modal-content" action="{{url('kb/permohonan-masuk/cuti',$detail->cuti_id)}}/tolak-kasubag" method="post">
                      @csrf
                      @method("PUT")
                      <div class="modal-header">
              ...
              <div class="modal fade" id="tolakPimpinan" data-bs-backdrop="static" tabindex="-1">
                <div class="modal-dialog">
                  <form class="modal-content" action="{{url('pimpinan/permohonan-masuk/cuti',$detail->cuti_id)}}/tolak-pimpinan" method="post">
                    @csrf
                    @method("PUT")
                    <div class="modal-header">
                      <h5 class="modal-title" id="backDropModalTitle">Alasan Penolakan</h5>
              ...
              <a href="{{url('pimpinan/permohonan-masuk/cuti',$detail->cuti_id)}}/terima-pimpinan" onclick="return confirm('Yakin Menerima Izin Ini?')" class="btn btn-success btn-block"><i class="fa fa-check"></i> Terima</a>
              ...
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tangguhkanKabid"><i class="fa fa-times"></i> Tangguhkan </button>
              <div class="modal fade" id="tangguhkanKabid" data-bs-backdrop="static" tabindex="-1">
                <div class="modal-dialog">
                  <form class="modal-content" action="{{url('pimpinan/permohonan-masuk/cuti',$detail->cuti_id)}}/tangguhkan" method="post">
                    @csrf
                    @method("PUT")
                    <div class="modal-header">
                      <h5 class="modal-title" id="backDropModalTitle">Alasan Tangguhkan</h5>
                      <button
                      type="button"
                      class="btn-close"
                      data-bs-dismiss="modal"
                    ...
                    <div class="modal-body">
                      <textarea name="alasan_tolak" id="" cols="30" rows="5" class="form-control" placeholder="Alasan Tangguhan"></textarea>
                    </div>
                    <div class="modal-footer">
                      <button type="submit" class="btn btn-primary">Tangguhkan</button>
                    </div>
                  </form>
                </div>
              </div>
              ...
              <div class="modal fade" id="perubahanKabid" data-bs-backdrop="static" tabindex="-1">
                <div class="modal-dialog">
                  <form class="modal-content" action="{{url('pimpinan/permohonan-masuk/cuti',$detail->cuti_id)}}/perubahan" method="post">
                    @csrf
                    @method("PUT")
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                      <textarea name="alasan_tolak" id="" cols="30" rows="5" class="form-control" placeholder="Alasan Perubahan"></textarea>
                    </div>
                    <div class="modal-footer">
              ...
              @elseif($detail->cuti_status == 6)
              <button class="btn btn-success">IZIN CUTI TELAH DITERIMA</button>
