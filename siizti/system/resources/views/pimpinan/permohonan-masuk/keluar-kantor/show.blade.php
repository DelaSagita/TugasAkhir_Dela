            ...
            <tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="{{url('pimpinan/permohonan-masuk/keluar-kantor',$detail->keluar_kantor_id)}}/terima" onclick="return confirm('Yakin Menerima Izin Ini?')" class="btn btn-success btn-block"><i class="fa fa-check"></i> Terima</a>
                  @elseif($detail->status == 1)
                  <button class="btn btn-success">
                    Izin Diterima
                  </button>
                  <a href="{{url('p/permohonan-masuk/keluar-kantor',$detail->keluar_kantor_id)}}/cetak" class="btn btn-dark"><i class="fa fa-print"></i> Cetak Surat</a>
                  ...
                  <div class="modal fade" id="backDropModal" data-bs-backdrop="static" tabindex="-1">
                    <div class="modal-dialog">
                      <form class="modal-content" action="{{url('pimpinan/permohonan-masuk/keluar-kantor',$detail->keluar_kantor_id)}}/tolak" method="post">
                        @csrf
                        @method("PUT")
