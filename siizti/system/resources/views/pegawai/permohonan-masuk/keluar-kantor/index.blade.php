						...
						<tr>
							...
							<td>
								<div class="btn-group">
									...
									@if($c->status == 0)
									<a href="{{url('p/permohonan-masuk/keluar-kantor',$c->keluar_kantor_id)}}/detail" class="btn btn-warning"><i class="fa fa-eye"></i></a>
									@elseif($c->status == 1)
									<a href="{{url('p/permohonan-masuk/keluar-kantor',$c->keluar_kantor_id)}}/detail" class="btn btn-warning"><i class="fa fa-eye"></i></a>
									<a href="{{url('p/permohonan/keluar-kantor',$c->keluar_kantor_id)}}/cetak" target="_blank" class="btn btn-dark"><i class="fa fa-file"></i></a>
									@elseif($c->status == 2)
									<a href="{{url('p/permohonan-masuk/keluar-kantor',$c->keluar_kantor_id)}}/detail" class="btn btn-warning"><i class="fa fa-eye"></i></a>
									@endif
