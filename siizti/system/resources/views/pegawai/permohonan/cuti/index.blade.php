						...
						<tr>
							...
							<td>
								<div class="btn-group">
									...
									@if($c->cuti_status == 6)
									<a href="{{url('/p/permohonan/cuti',$c->cuti_id)}}/cetak" target="_blank" class="btn btn-dark btn-sm"><i class="fa fa-file"></i> Cetak</a>
									@endif
									@if($c->cuti_status == 0)
									<a href="{{url('/p/permohonan/cuti',$c->cuti_id)}}/hapus" onclick="return confirm('yakin melanjutkan aksi?')" class="btn btn-danger btn-sm">Hapus</a>
									@endif
								</div>
							</td>
						</tr>
