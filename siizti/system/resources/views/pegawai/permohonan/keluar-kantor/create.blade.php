...
<div class="container mt-3 mb-5">
	...
	<div class="card">
		<div class="card-body">
			<form action="{{url('p/permohonan/keluar-kantor/create')}}" method="post" enctype="multipart/form-data">
				@csrf
				<div class="row">

					<div class="col-mad-12">
						<span>Alasan Keluar Kantor</span>
						<textarea name="alasan" id="" cols="30" rows="5" class="form-control" required placeholder="Deskripsikan alasan keluar kantor"></textarea>
					</div>

					<div class="col-md-6 mt-3">
						<span>Tanggal Izin Keluar Kantor</span>
						<input type="date" class="form-control" required  name="tgl_izin">
					</div>
					...
					<div class="col-md-6 mt-3">
						...
						<select required name="atasan_id" id="" class="form-control">
							...
							<option value="{{$b->pegawai_id}}">{{strtoupper($b->pegawai_nama)}}</option>
							@endforeach
