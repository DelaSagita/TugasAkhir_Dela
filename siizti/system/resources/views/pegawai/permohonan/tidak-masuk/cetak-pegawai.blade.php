...
<body>
    ...
    <div class="container">
        ...
        <table class="mt-2">
            ...
            <tr>
                <td colspan="2">
                    <p class="mt-3">Dengan ini mengajukan ijin tidak masuk kerja selama {{$jumlah_hari}} hari. pada {{Carbon\Carbon::parse($detail->tgl_mulai_izin)->isoFormat('dddd, D MMM Y')}} s.d {{Carbon\Carbon::parse($detail->tgl_selesai_izin)->isoFormat('dddd, D MMM Y')}} karena {{$detail->alasan_izin}}. <br>
                        &nbsp;&nbsp;&nbsp;&nbsp; Mohon kiranyan permohonan ijin saya untuk dapat dipertimbangkan. Atas perhatian Bapak saya hanturkan terima kasih.
                    </p>
                </td>
            </tr>
        </table>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-6 mt-5">
             <center>
                Ketapang, {{Carbon\Carbon::parse($detail->tgl_mulai_izin)->isoFormat('dddd, D MMM Y')}} <br>
                &nbsp; &nbsp; &nbsp; &nbsp; Pejabat pemberi izin <br>
                {!! QrCode::size(100)->generate(url('orisinalitas/tidak-masuk',$detail->kode_token)); !!} <br>
